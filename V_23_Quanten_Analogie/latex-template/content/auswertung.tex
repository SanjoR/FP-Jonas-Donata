...
\FloatBarrier
\begin{figure}
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_4_n1.pdf}}
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_4_n2.pdf}}\\
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_4_n3.pdf}}
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_4_n4.pdf}}
    \caption{Winkelabhängigkeit der Druckamplitude bei einer Resonanzfrequenz von \SI{5.0074}{\kilo\hertz} und einer Kugelflächenfunktion der $n$-ten Ordnung.}
    \label{fig:Amplitude_4}
\end{figure}
\begin{figure}
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n4.pdf}}
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n5.pdf}}\\
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n6.pdf}}
    \subfloat[][]{\includegraphics[width=0.45\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n7.pdf}}
