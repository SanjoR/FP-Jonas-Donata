...
zwischen der Datennahme mittels Oszilloskop und mittels dem Programm \texttt{SpectrumSLC}.
...
\begin{figure}
    ...
    \caption{Winkelabhängigkeit der Druckamplitude bei einer Resonanzfrequenz von \SI{5.0074}{\kilo\hertz} und Kugelflächenfunktion der $n$ Ordnung.}
    \label{fig:Amplitude_4}
\end{figure}
\begin{figure}
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n4.pdf}}
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n5.pdf}}\\
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n6.pdf}}
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{figure/Resonanz_Drewinkel_Amplitude_6_n7.pdf}}
