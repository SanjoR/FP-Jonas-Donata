...
\begin{equation*}
  m = \SI{0.40312(9)}{\kilo\eV} \quad b = \SI{-2.72(18)}{\kilo\eV}
\end{equation*}
...
\begin{align*}
  ...
  \text{Treffer}_{\text{max:gefunden}} &=  \rightarrow E_{\text{max}} = \SI{663.64(23)}{\kilo\eV}\\
...
$E_{max}$ nur durch die lineare Ausgleichsgraden kommen, da aber schon die Treffer stark von dem gesuchten Wert abweichen müssten die 
