...
Um den Detektor zu kalibrieren, wird eine \ce{^152Eu} Spektrum untersucht. Hierfür wird das Spektrum in Abhängigkeit des 
...
\begin{figure}
  ...
  \caption{Spektrum des \ce{^152Eu} Strahlers für die Kalibration des Detektors}
  \label{fig:Peaks_01}
\end{figure}
\FloatBarrier
...
\begin{figure}
  \centering
  \caption{Spektrum der \ce{^137Cs} Probe, hierbei wird der Kanal direkt in eine Energie umgerechnet.}
  \label{fig:Cs137}
